package br.com.sisdb.os.domain.model;
...
public class OrdemServico {
	...
	public boolean podeSerFinalizada() {
		return StatusOrdemSer.ABERTA.equals(getStatus());
	}
	...
	public void finalizar() {
		...
		System.out.println("entrei no nao finalizada");
	    setStatus(StatusOrdemSer.FECHADA);
